            ...
            <tr style={{ borderBottom: `1px solid ${C.border}` }}>
              ...
              {criteria.map((criterion) => (
                <th key={criterion.key} className="relative h-20 min-w-14 px-1 pb-2 text-left align-bottom" style={{ color: C.fg1 }}>
                  <button
                    className="absolute bottom-4 origin-bottom inline-flex items-center gap-1 whitespace-nowrap rounded px-1 py-0.5 text-left text-[10px] transition hover:bg-white/[0.04]"
